...
//        log.error("entity: " + entity + " id: " + id + " state: " + Arrays.toString(state) + " propertynames: "
//                + Arrays.toString(propertyNames) + " types: " + Arrays.toString(types));
//
        ...
        CustomSyncUtil syncUtil = new CustomSyncUtil();
        try {
                syncUtil.saveSyncRecord(entity,id,state, propertyNames,types);
//            restClientCustom.syncData("" + entity.getClass().getName() ,  (String) state[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
        /*
        log.error("entity: " + entity + " id: " + id + " state: " + state[0]);
        log.error("entity ----> " + entity.getClass().getName() + " id: " + id + " state: " + state[0]);
*/
        return b;
    }
