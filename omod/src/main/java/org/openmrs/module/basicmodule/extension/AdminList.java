 ...
 */
package org.openmrs.module.basicmodule.extension;
...
public class AdminList extends AdministrationSectionExt {
	...
	/*	if (Context.hasPrivilege("View Synchronization Records")) {
		...
		links.put("module/sync/help.htm", "sync");
		*/
		links.put("module/basicmodule/basicmoduleLink.form", "basicmodule.replace.this.link.name");
		return links;
	}
